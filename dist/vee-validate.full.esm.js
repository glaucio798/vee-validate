...
var Dictionary = /** @class */ (function() {
  ...
  Dictionary.prototype.format = function(locale, field, rule, values) {
    ...
    message =
      ((_c =
        (_b = (_a = this.container[locale]) === null || _a === void 0 ? void 0 : _a.fields) === null || _b === void 0
          ? void 0
          : _b[field]) === null || _c === void 0
        ? void 0
        : _c[rule]) ||
      ((_e = (_d = this.container[locale]) === null || _d === void 0 ? void 0 : _d.messages) === null || _e === void 0
        ? void 0
        : _e[rule]);
    if (!message) {
  ...
  Dictionary.prototype.hasRule = function(name) {
    var _a, _b;
    return !!((_b = (_a = this.container[this.locale]) === null || _a === void 0 ? void 0 : _a.messages) === null ||
    _b === void 0
      ? void 0
      : _b[name]);
  };
...
function _generateFieldError(field, value, ruleSchema, ruleName, params) {
  ...
  var values = __assign(
    __assign(
      __assign(__assign({}, params || {}), { _field_: field.name, _value_: value, _rule_: ruleName }),
      ruleTargets
    ),
    userTargets
  );
...
var ValidationProvider = Vue.extend({
  ...
  render: function(h) {
    ...
    extractVNodes(children).forEach(function(input) {
      ...
      if (isHTMLNode(input)) {
        _this.fieldName =
          ((_b = (_a = input.data) === null || _a === void 0 ? void 0 : _a.attrs) === null || _b === void 0
            ? void 0
            : _b.name) ||
          ((_d = (_c = input.data) === null || _c === void 0 ? void 0 : _c.attrs) === null || _d === void 0
            ? void 0
            : _d.id);
      }
            ...
            case 0:
              ...
              return [
                ...
                validate$r(
                  this.value,
                  rules,
                  __assign(__assign({ name: this.name || this.fieldName }, createLookup(this)), {
                    bails: this.bails,
...
var version = '3.2.5';
// Install all rules.
var RulesAsList = Object.keys(Rules).map(function(key) {
  return { schema: Rules[key], name: key };
});
